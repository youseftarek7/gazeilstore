...
export default function ProductDetailsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <SEO 
        title={`${product.name} | Ghazal Dental`}
        description={product.description}
        image={images[0]}
        url={`https://ghazaldental.com/?product=${(product as any).firestoreId || product.id}`}
        type="product"
        schema={{
        ...
        <div className="w-full md:w-1/2 p-6 flex flex-col justify-between overflow-y-auto">
          <div>
            ...
            <h3 className="font-display font-black text-2xl text-dark-blue mb-1 leading-tight">
              {product.name || "Clinical Dental Product"}
            </h3>
            ...
            <p className="text-slate-600 text-sm leading-relaxed mb-4">
              {product.description || "Certified university dental supplies and clinical grade materials for dentistry students and clinics."}
            </p>
