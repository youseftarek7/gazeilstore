...
import { Search, ShoppingCart, Menu, LayoutGrid } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-4 md:px-8 h-full" dir="ltr">
        ...
        <div className="flex items-center gap-1.5 md:gap-3">
          ...
          <button
            ...
            className="p-3 relative bg-medical-teal text-white hover:bg-medical-light rounded-full transition-all duration-300 shadow-md shadow-medical-teal/10 hover:shadow-lg active:scale-95"
